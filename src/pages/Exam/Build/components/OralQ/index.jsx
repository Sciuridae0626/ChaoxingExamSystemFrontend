...
import OralQCss from './index.module.css'
...
export default class OralQ extends Component {
    ...
    componentDidMount = () => {
        ...
        this.setState({picFileList: [{uid: nanoid(), url: this.props.picURL}]})
    }
    ...
    handleSave = (id) => {
        ...
        this.props.saveOralQ(id, title, grade)
    }
    /* 执行编辑小题的回调 */
    handleEdit = (id) => {
        this.props.editOralQ(id)
    }
    ...
    render() {
        ...
        return (<div className={this.props.isSave ? OralQCss.mainWrapper : OralQCss.mainWrapperShadow}>
            {/* 口语题题干行 */}
            <div className={OralQCss.lineWrapper} style={{color: '#7B7B7B', justifyContent: 'space-between', alignItems: 'flex-start'}}>
                <div className={OralQCss.lineWrapper} style={{alignItems: 'flex-start'}}> {this.props.index}.&emsp;
                ...
                {/* 右上角按钮组 */}
                <div className={OralQCss.lineWrapper} style={{ width: '30%', justifyContent: 'flex-end' }}>
            ...
            {/* 设置行 */}
            <div className={OralQCss.lineWrapper} style={{ justifyContent: 'space-between', marginTop: 20, alignItems: 'flex-end' }}>
                <div className={OralQCss.lineWrapper} style={{ width: '70%' }}></div>
                <div className={OralQCss.lineWrapper} style={{ width: '30%', justifyContent: 'flex-end' }}>
            ...
            <Modal title="自动换题" maskClosable={false} visible={isAutomaticVisible} onOk={() => this.handleOk('automatic')} okText='开始替换'
                ...
                <Form style={{width: '80%'}}>
                    ...
                    <Select mode="multiple" allowClear style={{width: '100%'}} placeholder="不选则默认任意题型">
                        <Option value='single'>口语题</Option>
                        <Option value='multiple'>口语题</Option>
