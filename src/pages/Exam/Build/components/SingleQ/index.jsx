...
export default class SingleQ extends Component {
    ...
    render() {
        ...
        return (<div className={this.props.isSave ? SingleQCss.mainWrapper : SingleQCss.mainWrapperShadow}>
            {/* 单选题题干行 */}
            <div className={SingleQCss.lineWrapper} style={{color: '#7B7B7B', justifyContent: 'space-between'}}>
                <div className={SingleQCss.lineWrapper}> {this.props.index}.&emsp;
            ...
            <div className={SingleQCss.lineWrapper} style={{ justifyContent: 'space-between', marginTop: 20, alignItems: 'flex-end' }}>
                <div className={SingleQCss.columnWrapper} style={{ width: '70%' }}>
                  {this.props.isSave ? <Radio.Group className={SingleQCss.columnWrapper} value={this.props.answer} disabled>
                    <Radio value='A' style={{marginBottom: '0.5em'}}>A.{this.props.A}</Radio>
                    <Radio value='B' style={{marginBottom: '0.5em'}}>B.{this.props.B}</Radio>
                    <Radio value='C' style={{marginBottom: '0.5em'}}>C.{this.props.C}</Radio>
                    <Radio value='D'>D.{this.props.D}</Radio>
                  </Radio.Group>
                  : <Radio.Group className={SingleQCss.columnWrapper} onChange={this.onRadiochange} defaultValue={this.props.answer}>
                    <Radio value='A' style={{marginBottom: '0.5em'}}>A.{this.props.A}</Radio>
                    <Radio value='B' style={{marginBottom: '0.5em'}}>B.{this.props.B}</Radio>
                    <Radio value='C' style={{marginBottom: '0.5em'}}>C.{this.props.C}</Radio>
                    <Radio value='D'>D.{this.props.D}</Radio>
