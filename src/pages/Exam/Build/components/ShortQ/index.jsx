    ...
    render() {
        ...
        return (<div className={this.props.isSave ? ShortQCss.mainWrapper : ShortQCss.mainWrapperShadow}>
            ...
            <div className={ShortQCss.columnWrapper} style={{ width: '100%' }}>
                <nobr style={{marginTop: 20, marginBottom: 5}}>关键词：</nobr>
                {this.props.isSave ? <Input value={this.props.keyword} disabled /> : <Input />}
            ...
            <div className={ShortQCss.lineWrapper} style={{ justifyContent: 'space-between', marginTop: 20, alignItems: 'flex-end' }}>
                <div className={ShortQCss.columnWrapper} style={{ width: '80%' }}>
                    <nobr style={{marginBottom: 5}}>参考答案：</nobr>
                    {this.props.isSave ? <TextArea style={{ resize: 'none' }} value={this.props.answer} autoSize={true} disabled />
